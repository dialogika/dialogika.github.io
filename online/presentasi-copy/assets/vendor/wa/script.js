$(document).on('click','.send_form', function(){
    ...
    var walink = 'https://web.whatsapp.com/send',
        phone = '6282137760669',
        walink2 = '*Kelas The Art of Presentation:* Saya tertarik untuk mendaftar' + '%0A%0A'
...
$(document).on('click','.send_contact', function(){
    ...
    var walink = 'https://web.whatsapp.com/send',
        phone = '6282137760669',
        walink2 = '*Kelas Teknis Penyampaian Presentasi:* Saya tertarik untuk mendaftar.' + '%0A%0A'
