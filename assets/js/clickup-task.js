...
const sendRegistrationData = document.querySelector(
  "#uploadForm .send_contact"
);
if (sendRegistrationData)
  sendRegistrationData.addEventListener("click", handleRegistrationEvent);
